...
<body>
	...
	<div class="main">
		<div class="form-header">
			<h3>BLOOD BANK REGISTRATION PAGE - FILL THE INFORMATION</h3>
		</div>
		<form name="reg_form" method="post" action="bloodbank_sign_process.php">
			<ul class="form-list">
				...
				<li class="form-element">
					...
					<input type="password" maxlength="40" pattern="[A-Za-z0-9!@.]*" id="pass" name="pass" required="required" />
				...
				<li class="form-element">
					<label class="form-label" for="name">Blood Bank Name:</label>
